...
const Sidebar = () => {
  ...
  return (
    ...
    <aside className="fixed left-0 top-0 h-screen w-16 bg-[#111111] flex flex-col items-center z-[100]">
      ...
      {/* Main Navigation - Flows below the 60px header zone */}
        ...
        {navItems.map((item) => {
          ...
          return (
            ...
            >
              ...
              <div className={`absolute inset-0 rounded-full transition-all duration-200 ${isActive
              ...
              <Icon
                size={22}
                className={`relative z-10 transition-colors duration-200 ${isActive ? 'text-[#111]' : 'text-gray-400 group-hover:text-white'
                  }`}
              />
            </button>
          );
